...
//// FFT primer: (F)ast (F)ourier (T)ransform
    ...
    // So, to detect sounds up to 20 kHz (Nyquist), you MUST sample at 40kHz or ksps(samples per second)
    //
    ...
    // 40000 / 512 ~~> 78 Hz
//// NOTE: by the end of the FFT calculations, your N samples are transformed into N/2 usable frequency values,
    //     so you don't need to wonder where they've gone.
...
void fftSetup(){
    ...
    double exponent = 0.66;  //// this number will have to change for the best output on different numbers of LEDs and different numbers of samples.
      ...
      // let me know if you figure out a way to calculate it automatically, I figured it manually by tring different numbers.
    ...
    // ** // the purpose of this loop is to set up the 'logarithmic' spacing 
...
//// remember that this loop is running independently of your 
